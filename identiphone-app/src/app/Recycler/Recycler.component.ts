...
export class RecyclerComponent implements OnInit {
  ...
  addParticipant(form: any): Promise<any> {
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceRecycler.updateParticipant(form.get('onwnerId').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.recyclerId) {
        formObject.recyclerId = result.recyclerId;
      } else {
        formObject.recyclerId = null;
      }
